...
$("#filter_loc").on("click",function(){
	...
	$.ajax({
		...
		success : function(data) {
			...
			v3 = '<div class="col-lg-4"><div class="panel panel-success" style="border-color: #467347;">'+
...
function getdata_stat_load(a,b,c) {
	var v1 = '';star=' <i class="fa fa-thumbs-up" aria-hidden="true" style="color:#467347;"></i> ';v_star='';
	loc_show = [];
	loc_show[0] = a;
	loc_show[1] = b;
	loc_show[2] = c;
	$.ajax({
		...
		success : function(data) {
			...
			$.each(jQuery.parseJSON(data), function(i, field) {
				...
				v1 += '<div class="col-lg-4"><div class="panel panel-success" style="border-color: #467347;">'+
					'<div class="panel-heading1">'+
